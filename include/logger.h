...
/** Legacy define, please use (LOGGER_PFX_EMPTY) */
#define LOGGER_PREFIX_EMPTY                            (LOGGER_PFX_EMPTY)

/** Legacy define, please use (LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE) */
#define LOGGER_PREFIX_FILE_FUNCTION_LINE               (LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE)

/** Legacy define, please use (LOGGER_PFX_FILE | LOGGER_PFX_LINE) */
#define LOGGER_PREFIX_FILE_LINE                        (LOGGER_PFX_FILE | LOGGER_PFX_LINE)

/** Legacy define, please use (LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE) */
#define LOGGER_PREFIX_FUNCTION_LINE                    (LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE)

/** Legacy define, please use (LOGGER_PFX_NAME) */
#define LOGGER_PREFIX_NAME                             (LOGGER_PFX_NAME)

/** Legacy define, please use (LOGGER_PFX_NAME | LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE) */
#define LOGGER_PREFIX_NAME_FILE_FUNCTION_LINE          (LOGGER_PFX_NAME | LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE)

/** Legacy define, please use (LOGGER_PFX_NAME | LOGGER_PFX_FILE | LOGGER_PFX_LINE) */
#define LOGGER_PREFIX_NAME_FILE_LINE                   (LOGGER_PFX_NAME | LOGGER_PFX_FILE | LOGGER_PFX_LINE)

/** Legacy define, please use (LOGGER_PFX_NAME | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE) */
#define LOGGER_PREFIX_NAME_FUNCTION_LINE               (LOGGER_PFX_NAME | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE)

/** Legacy define, please use (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL) */
#define LOGGER_PREFIX_NAME_LEVEL                       (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL)

/** Legacy define, please use (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE) */
#define LOGGER_PREFIX_NAME_LEVEL_FILE_FUNCTION_LINE    (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE)

/** Legacy define, please use (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FILE | LOGGER_PFX_LINE) */
#define LOGGER_PREFIX_NAME_LEVEL_FILE_LINE             (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FILE | LOGGER_PFX_LINE)

/** Legacy define, please use (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE) */
#define LOGGER_PREFIX_NAME_LEVEL_FUNCTION_LINE         (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE)
