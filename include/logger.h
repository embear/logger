...
/** Legacy variable, please use (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE) instead instead */
static const logger_prefix_t LOGGER_PREFIX_FUNCTION LOGGER_DEPRECATED((LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE)) = (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE);

/** Legacy variable, please use (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FILE | LOGGER_PFX_LINE) instead instead */
static const logger_prefix_t LOGGER_PREFIX_FILE LOGGER_DEPRECATED((LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FILE | LOGGER_PFX_LINE)) = (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FILE | LOGGER_PFX_LINE);

/** Legacy variable, please use (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE) instead instead */
static const logger_prefix_t LOGGER_PREFIX_FULL LOGGER_DEPRECATED((LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE)) = (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE);

/** Legacy variable, please use (LOGGER_PFX_EMPTY) instead */
static const logger_prefix_t LOGGER_PREFIX_EMPTY LOGGER_DEPRECATED((LOGGER_PFX_EMPTY)) = (LOGGER_PFX_EMPTY);

/** Legacy variable, please use (LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE) instead */
static const logger_prefix_t LOGGER_PREFIX_FILE_FUNCTION_LINE LOGGER_DEPRECATED((LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE)) = (LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE);

/** Legacy variable, please use (LOGGER_PFX_FILE | LOGGER_PFX_LINE) instead */
static const logger_prefix_t LOGGER_PREFIX_FILE_LINE LOGGER_DEPRECATED((LOGGER_PFX_FILE | LOGGER_PFX_LINE)) = (LOGGER_PFX_FILE | LOGGER_PFX_LINE);

/** Legacy variable, please use (LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE) instead */
static const logger_prefix_t LOGGER_PREFIX_FUNCTION_LINE LOGGER_DEPRECATED((LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE)) = (LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE);

/** Legacy variable, please use (LOGGER_PFX_NAME) instead */
static const logger_prefix_t LOGGER_PREFIX_NAME LOGGER_DEPRECATED((LOGGER_PFX_NAME)) = (LOGGER_PFX_NAME);

/** Legacy variable, please use (LOGGER_PFX_NAME | LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE) instead */
static const logger_prefix_t LOGGER_PREFIX_NAME_FILE_FUNCTION_LINE LOGGER_DEPRECATED((LOGGER_PFX_NAME | LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE)) = (LOGGER_PFX_NAME | LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE);

/** Legacy variable, please use (LOGGER_PFX_NAME | LOGGER_PFX_FILE | LOGGER_PFX_LINE) instead */
static const logger_prefix_t LOGGER_PREFIX_NAME_FILE_LINE LOGGER_DEPRECATED((LOGGER_PFX_NAME | LOGGER_PFX_FILE | LOGGER_PFX_LINE)) = (LOGGER_PFX_NAME | LOGGER_PFX_FILE | LOGGER_PFX_LINE);

/** Legacy variable, please use (LOGGER_PFX_NAME | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE) instead */
static const logger_prefix_t LOGGER_PREFIX_NAME_FUNCTION_LINE LOGGER_DEPRECATED((LOGGER_PFX_NAME | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE)) = (LOGGER_PFX_NAME | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE);

/** Legacy variable, please use (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL) instead */
static const logger_prefix_t LOGGER_PREFIX_NAME_LEVEL LOGGER_DEPRECATED((LOGGER_PFX_NAME | LOGGER_PFX_LEVEL)) = (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL);

/** Legacy variable, please use (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE) instead */
static const logger_prefix_t LOGGER_PREFIX_NAME_LEVEL_FILE_FUNCTION_LINE LOGGER_DEPRECATED((LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE)) = (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FILE | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE);

/** Legacy variable, please use (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FILE | LOGGER_PFX_LINE) instead */
static const logger_prefix_t LOGGER_PREFIX_NAME_LEVEL_FILE_LINE LOGGER_DEPRECATED((LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FILE | LOGGER_PFX_LINE)) = (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FILE | LOGGER_PFX_LINE);

/** Legacy variable, please use (LOGGER_PFX_NAME | LOGGER_PFX_LEVEL | LOGGER_PFX_FUNCTION | LOGGER_PFX_LINE) instead */
...
LOGGER_INLINE logger_return_t logger_disabled_ok(void)
{
  return(LOGGER_OK);
}
...
LOGGER_INLINE logger_id_t logger_disabled_id(void)
{
  return(0);
}


LOGGER_INLINE logger_bool_t logger_disabled_true(void)
{
  return(logger_true);
}
...
LOGGER_INLINE uint16_t logger_disabled_zero(void)
{
  return(0);
}
...
#define logger_output_function_level_set(__function, __level)                logger_disabled_ok()
#define logger_output_function_level_get(__function)                         logger_disabled_unkown()
#define logger_output_function_level_mask_set(__function, __level)           logger_disabled_ok()
#define logger_output_function_level_mask_get(__function)                    logger_disabled_unkown()
...
#define logger_output_function_color_is_enabled(__function)                  logger_disabled_false()
...
#define logger_id_output_level_mask_set(__id, __stream, __level)             logger_disabled_ok()
...
#define logger_id_output_color_is_enabled(__id, __stream)                    logger_disabled_false()
#define logger_id_output_function_register(__id, __function)                 logger_disabled_ok()
#define logger_id_output_function_deregister(__id, __function)               logger_disabled_ok()
#define logger_id_output_function_is_registered(__id, __function)            logger_disabled_false()
#define logger_id_output_function_level_set(__id, __function, __level)       logger_disabled_ok()
#define logger_id_output_function_level_get(__id, __function)                logger_disabled_err()
#define logger_id_output_function_level_mask_set(__id, __function, __level)  logger_disabled_ok()
#define logger_id_output_function_level_mask_get(__id, __function)           logger_disabled_err()
