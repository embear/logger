...
#define logger_is_initialized()                                         logger_ignore_false()
...
#define logger_output_is_registered(__stream)                           logger_ignore_false()
#define logger_output_level_set(__stream, __level)                      logger_ignore_ok()
#define logger_output_level_get(__stream)                               logger_ignore_unknown()
#define logger_output_color_enable(__stream)                            logger_ignore_ok()
#define logger_output_color_disable(__stream)                           logger_ignore_ok()
#define logger_output_color_is_enabled(__stream)                        logger_ignore_false()
...
#define logger_output_function_is_registered(__function)                logger_ignore_false()
#define logger_output_function_level_set(__function, __level)           logger_ignore_ok()
#define logger_output_function_level_get(__function)                    logger_ignore_unkown()
...
#define logger_output_function_color_is_enabled(__function)             logger_ignore_false()
...
#define logger_id_level_get(__id)                                       logger_ignore_unknown()
...
#define logger_id_output_is_registered(__id, __stream)                  logger_ignore_false()
...
#define logger_id_output_color_is_enabled(__id, __stream)               logger_ignore_false()
...
#define logger_id_output_function_is_registered(__id, __function)       logger_ignore_false()
...
#define logger_id_output_function_color_is_enabled(__id, __function)    logger_ignore_false()
#define logger_id_color_set(__id, __fg, __bg, __attr)                   logger_ignore_ok()
#define logger_id_color_reset(__id)                                     logger_ignore_ok()
#define logger_color_prefix_enable()                                    logger_ignore_ok()
#define logger_color_prefix_disable()                                   logger_ignore_ok()
#define logger_color_prefix_is_enabled()                                logger_ignore_false()
#define logger_color_message_enable()                                   logger_ignore_ok()
#define logger_color_message_disable()                                  logger_ignore_ok()
#define logger_color_message_is_enabled()                               logger_ignore_false()
